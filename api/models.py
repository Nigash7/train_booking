...
class Stop(models.Model):
    ...
    fare_from_previous = models.DecimalField(max_digits=10, decimal_places=2)
    order = models.IntegerField()  # Stop order (1,2,3...)

    def __str__(self):
        return f"{self.stop_name} - {self.train.train_name}"
